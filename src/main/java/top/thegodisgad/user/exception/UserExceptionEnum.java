...
//    EMAIL
//    GENDER
    REGISTERED_OUT_FAIL(300L, "注销失败", "REGISTERED_OUT_FAIL"),
    ...
    UPDATE_ADDRESS_EXISTENCE(201L, "地址已存在", "UPDATE_ADDRESS_EXISTENCE"),
    UPDATE_ERROR_NO_OLD_CER(201L, "没有旧密码", "UPDATE_ERROR.NO_HAVE_OLD_CER"),
    UNKNOWN_ERROR(11L, "未知错误", "Unknown_Error"), USER_EXISTENT(101L, "用户已存在!", "USER_EXISTENT");
