...
public class FileException extends BaseException
{
    ...
    public FileException(BaseExceptionInfoSet baseExceptionInfoSet) {
        super(baseExceptionInfoSet);
        setBaseCode("UserException");
    }

    public FileException(Throwable cause, BaseExceptionInfoSet baseExceptionInfoSet) {
        super(cause, baseExceptionInfoSet);
        setBaseCode("UserException");
    }

    public FileException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace, BaseExceptionInfoSet baseExceptionInfoSet) {
